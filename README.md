...
Because of lack of time, this project was finished as an assignment, it should not be seen as an official material for learning.

***Note***: 
- Some comments were written in Vietnamese because some code scripts were generated by LLMs, don't care 😊
- I recommend using Polar if you love your RAM 😊😊.
